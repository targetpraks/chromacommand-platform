  ...
  return (
    <div className="min-h-screen px-6 py-6">
      <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }}>
        ...
        <p className="text-xs text-on-dark-secondary mt-1">Configure your ChromaCommand environment</p>
      </motion.div>
          ...
          <Card className="p-4">
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-[10px] text-on-dark-secondary">HQ Admin · Infinity Brands</p>
                <p className="text-[10px] text-on-dark-secondary">ricardo@infxmedia.xyz</p>
              </div>
            </div>
        ...
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.1 }}>
          <Card className="p-4">
            ...
            <div className="space-y-3">
              <div>
                <label className="text-[10px] text-on-dark-secondary">Org Name</label>
                <div className="mt-1 px-3 py-1.5 bg-dark rounded-lg text-sm">Papa Pasta Franchising (PTY) Ltd</div>
              </div>
              <div>
                <label className="text-[10px] text-on-dark-secondary">Timezone</label>
              ...
              {[
                ...
                <div key={r.role} className="flex items-center justify-between p-2 bg-dark rounded-lg">
                  <div>
                    ...
                    <p className="text-[10px] text-on-dark-secondary">{r.access}</p>
                  </div>
                  <span className="text-[10px] text-on-dark-secondary">{r.users} users</span>
                </div>
              ))}
            </div>
          </Card>
