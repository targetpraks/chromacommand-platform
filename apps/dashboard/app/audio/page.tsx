  ...
  return (
    <div className="min-h-screen px-6 py-6">
      <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }}>
        ...
        <p className="text-xs text-on-dark-secondary mt-1">Manage music, playlists, and announcements per zone</p>
      </motion.div>

      <div className="mt-4 mb-6">
        <label className="text-xs text-on-dark-secondary mb-1 block">Store</label>
        <select
          value={selectedStore}
                ...
                <div key={z.id} className="p-3 bg-dark rounded-lg">
                  <div className="flex items-center justify-between mb-2">
                    <div>
                      ...
                      <p className="text-[10px] text-on-dark-secondary">{z.status}</p>
                    </div>
